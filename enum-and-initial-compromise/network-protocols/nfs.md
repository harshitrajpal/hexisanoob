...
```shell-session
harshitp0tter@htb[/htb]$ cat /etc/exports 
...
```shell-session
harshitp0tter@htb[/htb]$ sudo nmap 10.129.14.128 -p111,2049 -sV -sC
...
```shell-session
harshitp0tter@htb[/htb]$ sudo nmap --script nfs* 10.129.14.128 -sV -p111,2049
...
```shell-session
harshitp0tter@htb[/htb]$ showmount -e 10.129.14.128
...
```shell-session
harshitp0tter@htb[/htb]$ mkdir target-NFS
harshitp0tter@htb[/htb]$ sudo mount -t nfs 10.129.14.128:/ ./target-NFS/ -o nolock
harshitp0tter@htb[/htb]$ cd target-NFS
harshitp0tter@htb[/htb]$ tree .
...
```shell-session
harshitp0tter@htb[/htb]$ ls -l mnt/nfs/
...
```shell-session
harshitp0tter@htb[/htb]$ ls -n mnt/nfs/
...
```shell-session
harshitp0tter@htb[/htb]$ cd ..
harshitp0tter@htb[/htb]$ sudo umount ./target-NFS
```
