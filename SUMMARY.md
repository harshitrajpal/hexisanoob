...
* [Application Security](application-security/README.md)
  * [System Calls in Linux](application-security/system-calls-in-linux.md)
  * [Buffer Overflow Defenses](application-security/buffer-overflow-defenses.md)
  * [Format string vulnerabilities](application-security/format-string-vulnerabilities.md)
  * [Sample Github Actions](application-security/sample-github-actions.md)
  * [Basic Bugs in Demo Application](application-security/basic-bugs-in-demo-application.md)
  * [Using AFL++](application-security/using-afl++.md)
  * [GDB Basics](application-security/gdb-basics/README.md)
    * [Task 1 - Tamper strcmp logic](application-security/gdb-basics/task-1-tamper-strcmp-logic.md)
